...
class WorldMapAnimation: ObservableObject {
    ...
    static let worldMapImageNames = [
        ...
        "map_level_4_phase_8",
        "map_level_4_phase_9",
        "map_level_4_phase_10",
        "map_level_4_phase_11",
        "map_level_4_phase_12",
    ...
    func animateWorldMap() {
        ...
        if startIndex >= (WorldMapAnimation.worldMapImageNames.count) {
    ...
    private func animationLoop(startImageIndex: Int, loopIndex: Int = 0) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + WorldMapAnimation.animationDelay){
            ...
            if startImageIndex + loopIndex >= WorldMapAnimation.worldMapImageNames.count { return }
